...
def main():
    ...
    embeddings_path = '/home/mgil/ARTIBAND/data/ddi_bu/interaction/embeddings/ddi_molformer_embeddings.pt'
    results_path = '/home/mgil/ARTIBAND/data/ddi/interaction/resultats_ddi/molf/new_split'
    ...
    for run in range(num_runs):
        ...
        model = DDINetwork(embedding_dim=768, hidden_dim=512, output_dim=256, num_classes=num_classes, dropout_rate=0.3)
