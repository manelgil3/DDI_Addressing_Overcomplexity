...
def main():
    ...
    embeddings_path = '/home/mgil/ARTIBAND/data/ddi_bu/interaction/embeddings/ddi_gcn_embeddings.pt'
    results_path = '/home/mgil/ARTIBAND/data/ddi/interaction/resultats_ddi/gcn_t/new_split'
